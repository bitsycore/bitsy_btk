...
class BITSYTK_OT_images_change_alpha_mode(bpy.types.Operator):
    ...
    def menu_draw(self, context):
        ...
        self.layout.operator(BITSYTK_OT_images_change_alpha_mode.bl_idname, text="Change Alpha Mode")
    ...
    def execute(self, context):
        ...
        _change_alpha_mode_image_in_materials(mats, self.alpha_mode)
        return {"FINISHED"}
